...
ckpt_dir, figs_dir = dir_create('base_model_3')
    
FLAGS['saver_results_directory'] = figs_dir
#file_path = ckpt_dir+'/loss.csv'
per_epoch_path = ckpt_dir+'/loss_mean_std.csv'
...
def train_network():#model_dropout, learning_rate):
    with tf.Graph().as_default():
        ...
        rnn = model_TFLSTM3.GridCellNetwork(
...
for i in range(0, 1):
    train_network()
    print('using dp = ' + FLAGS['model_dropout_rates'] + ' and ' + FLAGS['training_optimizer_options'])
